...
async function daily(user) {
  ...
  if (userDb.daily.timestamp) {
    ...
    if (difference < 24) {
      ...
      return `🥺 *susurra tímidamente* Ya tomaste tu recompensa diaria... puedes volver en \`${getRemainingTime(nextUsage)}\` 🌸✨`;
    }
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      `😊 *susurra feliz* ¡Aquí tienes tu recompensa diaria! ${ECONOMY.DAILY_COINS}${ECONOMY.CURRENCY} uwu \n` +
